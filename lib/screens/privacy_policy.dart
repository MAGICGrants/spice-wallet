...
class PrivacyPolicy extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final inShell = ModalRoute.of(context)?.settings.arguments == true;
    final header = isDesktop
        ? Padding(
            ...
            child: Column(
              ...
              children: [
                DesktopBackLink(
                  label: inShell ? i18n.navigationBarSettings : i18n.back,
                  onTap: () => Navigator.pop(context),
                ),
                const SizedBox(height: 12),
                Text(i18n.welcomePrivacyLink, style: desktopTitleStyle),
              ],
            ),
          )
        : Padding(
            ...
            child: BrandScreenHeader(
              ...
              center: Text(i18n.welcomePrivacyLink, style: BrandText.appBar.copyWith(fontSize: 16)),
            ),
          );
    final body = SafeArea(
      child: Center(
    ...
    if (isDesktop && inShell) {
      return DesktopShell(active: DesktopNav.settings, child: body);
    }
    return Scaffold(backgroundColor: BrandColors.paper, body: body);
  }
}
